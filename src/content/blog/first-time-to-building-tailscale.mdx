---
title: "【實戰紀錄】OpenWrt：Tailscale 安裝與環境調校紀錄"
date: "2026-05-03"
description: "這是一篇關於在 OpenWrt 23.05.3 環境下部署 Tailscale 的技術筆記。紀錄了從嘗試錯誤、參數修正，到最終成功配置 Subnet Router 與 Exit Node 的過程，並附上安裝指南與防火牆建議。"

...
<TaskList tasks='[
  {"title":"API 層（SQLite → HTTP endpoints + ffmpeg on-demand）","completed":false},
  {"title":"Discord Bot 重寫（移除 Vue/Pinia）","completed":false},
  {"title":"Supabase 遷移","completed":false},
  {"title":"GIF LRU cache","completed":false}
]' />
